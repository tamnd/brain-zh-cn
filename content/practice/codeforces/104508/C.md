---
title: "CF 104508C - 通信问题"
description: "失败的提交中有两个独立的错误，这两个错误都可以从错误跟踪中看到。 首先，使用 input() 或 int(input()) 解析输入，假设一个干净的令牌结构，例如：但是从程序的角度来看，提供的测试输入严重畸形......"
...
[CF 104508C - 通信问题](https://codeforces.com/problemset/problem/104508/C)
 ...
 **已验证：** 是的
 ...
 失败的提交中有两个独立的错误，这两个错误都可以从错误跟踪中看到。 
