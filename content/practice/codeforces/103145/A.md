...
[CF 103145A - 矩阵](https://codeforces.com/problemset/problem/103145/A)
...
0, & \text{otherwise}.
\end{cases}$$等价地，增量恰好发生在$N+1$是一个$t$帕斯卡三角形枚举中的第 - 个二项式系数，并且在所有其他情况下领先组合索引保持不变。$$\boxed{\kappa_t(N+1)-\kappa_t(N)\in\{0,1\},\ \text{equal to }1 \text{ iff } N+1=\binom{m}{t}\text{ for some }m.}$$这样就完成了解决方案。 ∎
