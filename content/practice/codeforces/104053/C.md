...
[CF 104053C - 海关管制 2](https://codeforces.com/problemset/problem/104053/C)
...
原因：将每个集合分成“包含”$j$”和“不包含$j$” 是独立的$f$和$g$。 操作员$\bmod e_j$完全删除通过连接生成的组件$e_j$， 和$\sqcup$组合独立的子集族。 双方产生相同的集合集合，不涉及$j$- 扩展关闭。 
