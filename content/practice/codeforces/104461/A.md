...
[CF 104461A - 烹饪比赛](https://codeforces.com/problemset/problem/104461/A)
...
卷积输出`res[i]`对应于对齐移位`i - (n-1)`，而不是原始索引`i`。 因此，您的权重发生了变化，即使卷积本身是正确的，这也完全破坏了最终的数值结果。 
