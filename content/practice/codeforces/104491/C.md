...
[CF 104491C - 网络传输](https://codeforces.com/problemset/problem/104491/C)
...
```揭示一个关键模式：
 ...
 > 分成正数、负数和零，然后通过平衡累积和来构造，而不是通过配对端点来构造
...
# 要点
 ...
 一旦发生变化，所有先前的构造（包括这个）自然会产生错误的输出，例如`2510 -1 2510 -1 ...`。
