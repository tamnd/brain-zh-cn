...
[CF 104064H - 升温](https://codeforces.com/problemset/problem/104064/H)
...
### (a) 证明$f/(g \cup h) = (f/g) \cap (f/h)$让$\alpha$随心所欲。 根据定义，$$\alpha \in f/(g \cup h)$$当且仅当对于每个$\beta \in g \cup h$,$$\alpha \cup \beta \in f \quad \text{and} \quad \alpha \cap \beta = \varnothing.$$自从成为会员以来$g \cup h$相当于会员资格$g$或者$h$，这个条件相当于两个语句同时有效：
